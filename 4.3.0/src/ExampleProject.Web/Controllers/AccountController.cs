...
using ExampleProject.Sessions;
using ExampleProject.Web.Controllers.Results;
using ExampleProject.Web.Models;
using ExampleProject.Web.Models.Account;
...
{
    public class AccountController : ExampleProjectControllerBase
    {
